        ...
        <div class="p-10 bg-gradient-to-br from-pink-50 to-indigo-100 grid place-items-center">
          <div class="w-6/12 mx-auto rounded border">
            <div class="bg-white p-10 shadow-sm">
              ...
              <!-- What is term -->
              <div @click="count = 0" class="transition hover:bg-indigo-50">
                <!-- header -->
                ...
                <!-- Content -->
                <div class="px-5 pt-0 text-left pb-5" v-show="count == 0">
              ...
              <div @click="count = 1" class="transition hover:bg-indigo-50">
                <!-- header -->
                <div class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
                ...
                <!-- Content -->
                <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="count == 1">
                  <p class="leading-6 font-light pl-9 ">
              ...
              <!-- Accordion Wrapper -->
              <div @click="count = 2" class="transition hover:bg-indigo-50">
                <!-- header -->
                <div class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
                ...
                <!-- Content -->
                <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="count == 2">
                  <p class="leading-6 font-light pl-9">
              ...
              <!-- Accordion Wrapper -->
              <div @click="count = 3" class="transition hover:bg-indigo-50">
                <!-- header -->
                <div class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
                ...
                <!-- Content -->
                <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="count == 3">
                  <p class="leading-6 font-light pl-9">
