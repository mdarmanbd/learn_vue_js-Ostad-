    ...
    <div class="py-20 bg-gray-50">
      <div class="container mx-auto px-6">
        <div class="mb-16 text-center">
          <h2 class="mb-4 text-center text-2xl text-gray-900 font-bold ">Team Member</h2>
        ...
        <div class="grid gap-12 items-center grid-cols-3">
          ...
          <div class="space-y-4 text-center" v-for="(person,index) in persons" :key="person.id">
            <!-- <img class="mx-auto object-cover rounded-xl w-64 " :class="2==person.id?'h-72':'h-60'" :src="person.profilePhoto"> -->
            <img class="mx-auto object-cover rounded-xl w-64 " :class="2== index+1 ?'h-72':'h-60'" :src="person.profilePhoto">
            <div>
