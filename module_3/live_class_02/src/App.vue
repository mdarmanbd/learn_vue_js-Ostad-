...
// class binding
  ...
  // const textWhite = 'text-white text-xl font-bold'
...
<template>
  <section>
    ...
    <section class="mt-10">
      <div class="h-16 flex items-center justify-center text-white" :class="[weekday === true?colors.bgColor:bgOrange , weekday === true?'text-2xl':'text-4xl']">
        It's a weekday!
      </div>
    </section>
  ...
  <section class="container mx-auto">
    ...
    <section class="flex space-x-10">
      ...
      <div class="w-1/3 h-16" :style="bgDarkGreen"></div>
    </section>

    <section class="mt-10">
      <div class="h-16 flex items-center justify-center text-white" :style="[weekday == true?[bgGreen,'font-size:30px']:[bgOrange,'font-size:12px']]">
