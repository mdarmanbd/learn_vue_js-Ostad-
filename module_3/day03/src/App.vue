  ...
  <section class="container mx-auto p-10">
        ...
        <!-- <section class="main flex space-x-4">
            <div class="flex space-y-4 flex-col w-1/3">
                <img v-bind:title="images[0].title" :src="images[0].image" >
            ...
            <div class="flex space-y-4 flex-col w-1/3">
                <img :title="images[1].title" :src="images[1].image" >
            ...
            <div class="flex space-y-4 flex-col w-1/3">
                <img :title="images[2].title" :src="images[2].image" >
        ...
        <section>
          <div class="flex space-y-4 flex-col w-1/3">
                <img v-bind="myObject">
                <p class="text-left">{{ myObject.title }}</p>
                <a target="_blank" :href="myObject.link"  class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded w-40 text-center ">
                    Image Source
                </a>
            </div>
        </section>
